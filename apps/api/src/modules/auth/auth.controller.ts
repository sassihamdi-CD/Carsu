...
import { ApiOperation, ApiResponse, ApiTags, ApiOkResponse, ApiCreatedResponse, ApiBearerAuth } from '@nestjs/swagger';
...
export class AuthController {
  ...
  @ApiOperation({ summary: 'Create a new user and default tenant; returns JWT' })
  @ApiCreatedResponse({ description: 'User created; JWT issued', type: TokenResponseDto })
  ...
  @ApiOkResponse({ description: 'Authenticated; JWT issued', type: TokenResponseDto })
  @ApiResponse({ status: 400, description: 'Validation error' })
  ...
  @ApiBearerAuth()
  @ApiOkResponse({ description: 'Current user info with memberships', type: MeResponseDto })
